...
class DatasetOptions(StrictStruct):
    ...
    dataroot_ref: Annotated[
        str | list[str] | None,
        Meta(
            description="Path to reference-domain images for unpaired/blind training."
        ),
    ] = None
...
class PathOptions(StrictStruct):
    ...
    pretrain_network_deg: str | None = None
    pretrain_network_d_lr: str | None = None
    pretrain_network_d_sr: str | None = None
    param_key_deg: str | None = None
    param_key_d_lr: str | None = None
    param_key_d_sr: str | None = None
    strict_load_deg: bool = True
    strict_load_d_lr: bool = True
    strict_load_d_sr: bool = True
...
class PDMTrainOptions(StrictStruct):
    optim_deg: bool = True
    optim_sr: bool = True
    d_ratio: int = 1
    buffer_size: int = 0
...
class PDMValOptions(StrictStruct):
    crop_test: bool = False
    crop_size: int = 0


class BlindOptions(StrictStruct):
    method: Literal["pdm_sr", "pdm_resshift"] = "pdm_sr"
...
class TrainOptions(StrictStruct):
    ...
    optim_deg: dict[str, Any] | None = None
    optim_d_lr: dict[str, Any] | None = None
    optim_d_sr: dict[str, Any] | None = None
    optim_ae: Annotated[
        dict[str, Any] | None,
        Meta(description="The optimizer to use for the autoencoder model."),
    ] = None
    pdm: PDMTrainOptions | None = None
...
class ReduxOptions(StrictStruct):
    ...
    network_deg: Annotated[
        dict[str, Any] | None,
        Meta(description="The options for the PDM degradation model."),
    ] = None
    network_d_lr: Annotated[
        dict[str, Any] | None,
        Meta(description="The options for LR-domain discriminator in blind SR."),
    ] = None
    network_d_sr: Annotated[
        dict[str, Any] | None,
        Meta(description="The options for SR-domain discriminator in blind SR."),
    ] = None
    network_ae: Annotated[
        dict[str, Any] | None,
        Meta(description="The options for the autoencoder model."),
    ] = None
    blind: BlindOptions | None = None
